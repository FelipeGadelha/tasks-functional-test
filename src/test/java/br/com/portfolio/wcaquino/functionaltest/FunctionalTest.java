package br.com.portfolio.wcaquino.functionaltest;
...
public class FunctionalTest {
	...
	public WebDriver acessarAplicacao() throws MalformedURLException {
		...
		WebDriver driver = new RemoteWebDriver(new URL("http://192.168.0.246:4444/wd/hub"), cap);
		driver.navigate().to("http://192.168.0.246:8001/tasks");
